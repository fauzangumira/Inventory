<div class="span3" id="sidebar">
    ...
    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
        ...
        <li class="active">						
            <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs"><i class="icon-chevron-right"></i><i class="icon-tablet icon-large"></i>&nbsp;Manage DRC
                <div class="muted pull-right"><i class="caret"></i></div></a>						
            <ul id="bs" class="in collapse">
                <li class="">
                    <a href="app_name_drc.php"><i class="icon-chevron-right"></i><i class="icon-folder-open-alt"></i> Add Application Name</a>
                </li> 
				<li class="">
                    <a href="dev_name_drc.php"><i class="icon-chevron-right"></i><i class="icon-folder-open-alt"></i> Add Device Name</a>
                </li>
				<li class="">
                    <a href="ci_name_drc.php"><i class="icon-chevron-right"></i><i class="icon-folder-open-alt"></i> Add CI Name</a>
                </li>
				<li class="">
                    <a href="host_name_drc.php"><i class="icon-chevron-right"></i><i class="icon-folder-open-alt"></i> Add Host Name</a>
                </li>
				<li class="">
                    <a href="plt_name_drc.php"><i class="icon-chevron-right"></i><i class="icon-folder-open-alt"></i> Add Platform Name</a>
                </li>
				<li class="">
                    <a href="ip_name_drc.php"><i class="icon-chevron-right"></i><i class="icon-folder-open-alt"></i> Add IP Address</a>
                </li> 
				<li class="">
                    <a href="os_name_drc.php"><i class="icon-chevron-right"></i><i class="icon-folder-open-alt"></i> Add Operating System Name</a>
                </li> 
				<li class="">
                    <a href="cmdb_name_drc.php"><i class="icon-chevron-right"></i><i class="icon-laptop"></i> Create CMDB</a>
                </li> 
                <!--<li class="">
                    <a href="device_stocks.php"><i class="icon-chevron-right"></i><i class="icon-desktop"></i> Device / Stocks</a>
                </li>-->
                <li>
                    <a href="newdevice.php"><i class="icon-chevron-right"></i><i class="icon-laptop"></i> Assign&nbsp;<span class="label label-success">New</span>&nbsp;Application
