<div class="row-fluid">				  
   <a href="dev_name_drc.php" class="btn btn-info" id="add" data-placement="right" title="Click to Add Client" ><i class="icon-plus-sign icon-large"></i> Add Device Name</a>
	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query = mysql_query("select * from device_name_drc where dev_id = '$get_id'")or die(mysql_error());
...
mysql_query("update device_name_drc set dev_name = '$dev_name'  where dev_id = '$get_id' ")or die(mysql_error());

mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit device name $dev_name')")or die(mysql_error());	
?>
<script>
