    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php include('edit_ci_name_drc_form.php'); ?>		   			
				</div>
				<?php	
	             $count_os_name=mysql_query("select * from ci_name_drc");
					...
					<div class="empty">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-folder-open-alt"></i> CI Name (s) List</div>
								...
								<form action="delete_ci_name_drc.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
												...
												<a rel="tooltip"  title="Edit Client" id="e<?php echo $id; ?>" href="edit_ci_name_drc.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"> Edit</i></a>
												</td>
