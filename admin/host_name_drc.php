    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="span3" id="adduser">
                <?php include('add_host_name_drc.php'); ?>		   			
            </div>
            <div class="span6" id="">
                <div class="row-fluid">
                    <!-- block -->
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysql_fetch_array($host_name_query)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="75">
                                                        <a rel="tooltip"  title="Edit Host Name" id="e<?php echo $id; ?>" href="edit_host_name_drc.php<?php echo '?id=' . $id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"> Edit</i></a>
                                                    </td>
