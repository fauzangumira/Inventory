...
--
-- Host: localhost
-- Generation Time: Jun 04, 2018 at 03:04 PM
...
(1, 'admin', '2018-02-06 10:33:52', 'Add device Type test'),
(2, 'admin', '2018-02-06 10:34:23', 'Add device Detail id 10&nbspName&nbsptest'),
(3, 'admin', '2018-02-06 10:34:54', 'Assign Device id 1&nbspName&nbsptest to location id 22&nbspName&nbspComlab A'),
(4, 'admin', '2018-02-06 10:35:21', 'Add device Detail id 2&nbspName&nbspkyboard'),
(5, 'admin', '2018-02-15 12:51:42', 'Add device Detail id 4&nbspName&nbspmouse'),
(6, 'admin', '2018-02-15 12:57:01', 'Add device Detail id 4&nbspName&nbspmouse'),
(7, 'admin', '2018-02-15 13:17:33', 'Edit device info mouse'),
(8, 'admin', '2018-02-15 13:19:01', 'Edit device info mouse'),
(9, 'admin', '2018-02-15 13:19:40', 'Edit device info mouse');
...
(5, 'Muhammad', 'Dahril', 'admin', 'admin', 'uploads/NO-IMAGE-AVAILABLE.jpg');
...
CREATE TABLE IF NOT EXISTS `stdevice` (
  ...
  `gambar_asli` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `stdevice` (`id`, `dev_id`, `dev_desc`, `dev_serial`, `dev_brand`, `dev_model`, `dev_status`, `tanggal`, `gambar_kecil`, `gambar_asli`) VALUES
(2, 4, '<p>nnnnnnnnn</p>\r\n', 'fddfsdfsdf', 'fsafs', 'aaaaa', 'New', '2018-02-09', '', 'uploads/back.jpg');
...
(190, 'admin', '2018-01-29 12:03:11', '2018-02-15', 5, 0),
(191, 'admin', '2018-01-29 14:13:25', '2018-02-15', 5, 0),
(192, 'admin', '2018-01-29 14:40:06', '2018-02-15', 5, 0),
(193, 'admin', '2018-02-06 09:12:55', '2018-02-15', 5, 0),
(194, 'admin', '2018-02-06 09:48:58', '2018-02-15', 5, 0),
(195, 'admin', '2018-02-15 10:25:17', '2018-02-15', 5, 0),
(196, 'admin', '2018-02-15 10:34:02', '2018-02-15', 5, 0),
(197, 'admin', '2018-02-15 10:46:42', '2018-02-15', 5, 0),
(198, 'admin', '2018-02-18 21:58:31', '', 5, 0),
(199, 'admin', '2018-02-22 11:36:07', '', 5, 0),
(200, 'admin', '2018-05-17 09:04:30', '', 5, 0),
(201, 'admin', '2018-05-25 14:34:17', '', 5, 0),
(202, 'admin', '2018-05-25 15:14:03', '', 5, 0);
